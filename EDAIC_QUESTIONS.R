...
run <- function() {
    ...
    soe_list <- list(
        ...
        anatomy = c(
            ...
            "What are the contraindications to performing an epidural?",                                                               #             Inability to monitor, Raised intracranial pressure, severe hypovolemia, sepsis
