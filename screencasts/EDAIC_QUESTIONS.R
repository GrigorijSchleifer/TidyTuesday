...
run <- function() {
  ...
  "How would you perform a subgluteal sciatic nerve block?",
  "How would you perform a popliteal sciatic nerve block?",
  "How would you perform an ankle block?",
  "How would you perform a saphenous nerve block?",
  "How would you perform an ilioinguinal and iliohypogastric nerve block?",
  "How would you perform a pudendal nerve block?",
  "How would you perform a dorsal penile nerve block?",
  "How would you perform a lateral femoral cutaneous nerve block?",
  "How would you perform a greater occipital nerve block?"
